...
%{
    ...
    This code performs reconstructions without "spatial sectioning" method.
...
sample_spacing = aperturefullsize(1)/(size(u_total,1) - 1); % calculate sampling space on the captured wavefront
